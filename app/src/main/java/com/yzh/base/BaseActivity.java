...
import com.yzh.socket.SocketCommand;
import com.yzh.socket.SocketMsg;
...
//		String msg = "onEventMainThread收到了消息：" + eventPackage.getCommandId()+eventPackage.getCommandData();
//		LogUtils.logMessage("harvic", msg);
        ToastUtils.showTextToast(context, getResources().getString(R.string.toast_msg_error_internet));
        if (dlgWaiting.isShowing()) {
            dlgWaiting.dismiss();
        }
